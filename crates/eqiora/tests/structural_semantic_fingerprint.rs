...
fn rational_dimension_meaning_survives_canonical_model_replay() {
    ...
    let old_schema =
        current_schema.replace("eqiora.model-envelope/v21", "eqiora.model-envelope/v10");
    ...
    assert_eq!(
        ...
        SemanticFingerprintGeneration::V16
    );
}
...
fn source_native_codec_and_allocation_routes_share_only_structural_identity() {
    ...
    assert_eq!(fingerprint.generation(), SemanticFingerprintGeneration::V16);
