...
pub mod api {
    ...
    pub use eqiora_api::{
        ...
        ParameterGeometryRegenerationResult, REFERENCE_EXECUTION_ADAPTER, ReferenceAcceptance,
        ...
        ReferenceRunResult, ReferenceSeries, RemeshingTrajectoryReplayInputV1,
        ScalarEllipticBalanceEvidence, ScalarEllipticExecutionEnvironment, ScalarEllipticIntent,
        ...
        ScalarFieldSummary, SemanticFingerprintGeneration, StructuralSemanticFingerprint,
