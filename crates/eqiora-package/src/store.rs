...
use crate::{ContractError, NormalizedRelativePath, PackageReleaseV1, SourceBundleDigest};

const MAX_RELEASE_BYTES: usize = crate::canonical::MAX_CANONICAL_JSON_BYTES;
...
impl PackageStore for DirectoryPackageStore {
    fn load_exact(
        ...
        let limit = max_bytes.min(MAX_RELEASE_BYTES);
