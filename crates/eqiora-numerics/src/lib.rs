...
pub mod facade {
    pub use super::{
        AcceptedAleFsiRemeshProjection2d, AcceptedResolvedAleFsiRemesh2d, AleFsiBoundary2d,
        ...
        BasisTabulation, CartesianBoundaryEntry2d, CartesianBoundaryInventory2d,
        CartesianLinearElasticity2dSolution, CartesianMesh, CartesianQ1Field,
        CartesianQ1VectorField2d, CartesianVectorErrorNorms,
        CellCenteredNavierStokesInitialState2d, CellCenteredNavierStokesStepEvidence2d,
        CellCenteredPressureField2d, CellCenteredVelocityField2d, CellConstantSpace,
        ConformingCartesianInterfaceMap2d, ConformingCartesianLinearElasticityPair2dSolution,
        ...
        DefaultScalarElliptic1dConfig, Diffusion1d, DirichletBoundary1d, DiscreteSpace,
        FinalizedConformingIsotropicElasticityCartesianPair2dProblem,
        ...
        HypercubeQ1Space, IncompressibleFlowScaleProfile2d,
        InertialIncompressibleNewtonianCartesianModel2d, IsotropicElasticityCartesianModel2d,
        IsotropicElastodynamicsCartesianModel2d, LocalDof, LocalOperator,
        MiniNavierStokesStepPlan2d, NonZeroStepCount, P1HarmonicMeshMotionAction2d,
        P1HarmonicMeshMotionAction3d, PhysicalBoundaryDisposition, PhysicalBoundaryQuantity,
        PiecewiseLinearField1d, PoissonComparisonRow, PoissonSolution1d, PrescribedBoundaryLaw,
        ...
        SimplexP1BubbleSpace, SimplexP1Space, SimplicialMeshVelocity,
        ...
        SpatialDesignCoordinate, SteadyIncompressibleStokesCartesianModel2d,
        SteadyStokesMiniSolution2d, SteadyStokesNormalPressure2d, SteadyStokesPressureReference2d,
        ...
        transient_navier_stokes_cell_centered_plan_2d,
        transient_navier_stokes_cell_centered_requirements_2d,
        transient_navier_stokes_fieldwise_requirements_2d,
    };
}
