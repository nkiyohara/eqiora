...
pub use crate::canonical_stokes::{
    ...
    SteadyIncompressibleStokesModel2d, SteadyStokesGeometryBinding2d, SteadyStokesMiniSolution2d,
    ...
    lower_steady_incompressible_stokes_geometry_2d,
    ...
    solve_resolved_steady_stokes_mini_2d_with_assembly, steady_stokes_fieldwise_requirements_2d,
    steady_stokes_mini_plan_2d, transient_navier_stokes_cell_centered_plan_2d,
