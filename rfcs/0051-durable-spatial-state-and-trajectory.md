...
### Retired fixed-mesh 2D replay profile

The borrowed V1 fixed-mesh replay composition was removed after common
Plan-owned trajectories became the sole Python result path. The underlying
content-addressed artifacts remain available to the surviving V2/V3 ALE,
remeshing, storage, and dataset consumers; no public compatibility owner is
retained.
