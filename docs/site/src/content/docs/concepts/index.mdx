---
title: Concepts
description: Semantic models, lowered contracts, Realizations, artifacts, and bounded evidence.
---
...
- <ExactSourceLink path="docs/glossary.md" kind="blob">Project glossary</ExactSourceLink>
- <ExactSourceLink path="rfcs" kind="tree">Accepted and active RFCs</ExactSourceLink>
- <ExactSourceLink path="docs/capability-matrix.md" kind="blob">Capability and maturity matrix</ExactSourceLink>
