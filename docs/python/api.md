...
@final
class Parameter:
    def __new__(cls, name: str, *, value: float, value_type: ValueType | None=None) -> Self: ...
    @property
    def name(self) -> str: ...
    @property
    def dimension(self) -> Dimension: ...
...
class Component:
    ...
    def let_alias(self, name: str, expression: Expression | int | float, *, value_type: ValueType | None=None, doc: str | None=None) -> Expression: ...
