...
API presence is neither capability evidence nor maturity. All 19 module summaries and all 215 canonical declaration summaries are source-traced; non-dunder member coverage remains **5 authoritative summaries and 704 signature-only entries under documented owning types**.
