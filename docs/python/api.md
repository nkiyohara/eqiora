...
API presence is neither capability evidence nor maturity. All 16 module summaries and all 142 canonical declaration summaries are source-traced; non-dunder member coverage remains **0 authoritative summaries and 549 signature-only entries under documented owning types**.

Inventory: 16 modules, 167 literal public spellings, 142 canonical grouped declarations, 734 visible method signatures (549 non-dunder and 185 dunder), and 65 visible class assignments.
