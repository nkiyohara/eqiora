...
API presence is neither capability evidence nor maturity. All 15 module summaries and all 118 canonical declaration summaries are source-traced; non-dunder member coverage remains **0 authoritative summaries and 485 signature-only entries under documented owning types**.

Inventory: 15 modules, 142 literal public spellings, 118 canonical grouped declarations, 651 visible method signatures (485 non-dunder and 166 dunder), and 65 visible class assignments.
