...
@overload
def run(model: Model, *, plan: fluid.SteadyStokesPlan) -> fluid.CircularHoleSteadyStokesResult: ...
```
...
@overload
def submit(model: Model, *, plan: fluid.SteadyStokesPlan) -> Run[fluid.CircularHoleSteadyStokesResult]: ...
```
