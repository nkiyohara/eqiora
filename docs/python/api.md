...
API presence is neither capability evidence nor maturity. All 16 module summaries and all 136 canonical declaration summaries are source-traced; non-dunder member coverage remains **0 authoritative summaries and 522 signature-only entries under documented owning types**.

Inventory: 16 modules, 161 literal public spellings, 136 canonical grouped declarations, 705 visible method signatures (522 non-dunder and 183 dunder), and 65 visible class assignments.
