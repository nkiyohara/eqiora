...
total successful true-residual applications from every zero-work boundary.
It also freezes a simultaneous stale-evidence/stale-provider mutation whose
first and only rejection remains `catalog.evidence-mismatch` for every complete
objective trace.
