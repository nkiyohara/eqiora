...
Only the numerical point may be traced. The exact Model, Realization, ordered
input identities, output identity, shapes, dtype, layout, and host-CPU platform
remain static; the concrete CPU ordinal follows the input. Unsupported
