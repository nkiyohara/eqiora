...
Realization v2 lineage only when the accepted exact-source chordal artifact
owner replays its source, authored region, correspondence, private reference,
and complete imported mesh together. `eqiora-api` replays the current Model, semantic revision,
