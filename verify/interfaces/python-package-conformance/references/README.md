...
The primary route consumes only protected predecessor contracts: typed release
normalization, exact resolution, locked compilation, compilation-record replay,
...
external resolution bytes, treat raw release JSON representation as identity,
skip re-derived source or semantic checks, enumerate a store, follow a symlink,
return a partial success value, reorder diagnostics, trust a caller-constructed
report, infer scientific correctness, or execute package-provided content.
