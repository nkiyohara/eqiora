...
deterministic Model and Transaction v7 round-trip, current-codec feature
...
wrong-kind parents fail whole-Model validation. Model/Transaction v6 decoders
reject the v7 meaning, and malformed digest text fails as `EQ0901` without
version fallback.
