...
#129, *Admit one named geometry-boundary Relation scope with inlet/outlet
normals*. The base revision is
...
The first currently registers the opposite Relation outcome; see *Sequencing*
in [the case README](../README.md).
