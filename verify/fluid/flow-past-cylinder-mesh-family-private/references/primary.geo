// Eqiora-authored structural MESH0 fixture recipe. This is not a production mesh.
SetFactory("Built-in");

segments = DefineNumber[8, Name "Parameters/segments"];
mesh_size = DefineNumber[0.12, Name "Parameters/mesh_size"];
