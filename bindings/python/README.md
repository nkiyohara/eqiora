...
**Alpha — `0.1.0a7`.** See [Capabilities](https://eqiora.org/capabilities/)
...
instructions when trying features newer than `0.1.0a7`.
...
`0.1.0a7` is an alpha prerelease. Python APIs and saved-file formats may change
