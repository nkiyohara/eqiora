...
function Ti(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Di(i)) i.isRenderTargetTexture ? (V("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
...
var Ri = class {
	...
	constructor(e, t, n, r) {
		...
		this.name = e, this.times = Li(t, this.TimeBufferType), this.values = Li(n, this.ValueBufferType), this.setInterpolation(r || this.DefaultInterpolation);
	}
	static toJSON(e) {
	...
	InterpolantFactoryMethodBezier(e) {
		let t = new Hi(this.times, this.values, this.getValueSize(), e);
...
Ui.prototype.ValueTypeName = "", Ui.prototype.TimeBufferType = Float32Array, Ui.prototype.ValueBufferType = Float32Array, Ui.prototype.DefaultInterpolation = L;
var Wi = class extends Ui {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Wi.prototype.ValueTypeName = "bool", Wi.prototype.ValueBufferType = Array, Wi.prototype.DefaultInterpolation = Ne, Wi.prototype.InterpolantFactoryMethodLinear = void 0, Wi.prototype.InterpolantFactoryMethodSmooth = void 0;
var Gi = class extends Ui {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
Gi.prototype.ValueTypeName = "color";
var Ki = class extends Ui {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
...
Ji.prototype.ValueTypeName = "quaternion", Ji.prototype.InterpolantFactoryMethodSmooth = void 0;
var Yi = class extends Ui {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
Yi.prototype.ValueTypeName = "string", Yi.prototype.ValueBufferType = Array, Yi.prototype.DefaultInterpolation = Ne, Yi.prototype.InterpolantFactoryMethodLinear = void 0, Yi.prototype.InterpolantFactoryMethodSmooth = void 0;
var Xi = class extends Ui {
	constructor(e, t, n, r) {
		super(e, t, n, r);
	}
};
Xi.prototype.ValueTypeName = "vector";
var Zi = /*@__PURE__*/ new K(), Qi = /*@__PURE__*/ new Et(), $i = /*@__PURE__*/ new K(), ea = class extends Sn {
	constructor() {
	...
	updateWorldMatrix(e, t, n = !1) {
		super.updateWorldMatrix(e, t, n), this.matrixWorld.decompose(Zi, Qi, $i), $i.x === 1 && $i.y === 1 && $i.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Zi, Qi, $i.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
...
}, oa = -90, sa = 1, ca = class extends Sn {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new ia(oa, sa, e, t);
		r.layers = this.layers, this.add(r);
		let i = new ia(oa, sa, e, t);
		i.layers = this.layers, this.add(i);
		let a = new ia(oa, sa, e, t);
		a.layers = this.layers, this.add(a);
		let o = new ia(oa, sa, e, t);
		o.layers = this.layers, this.add(o);
		let s = new ia(oa, sa, e, t);
		s.layers = this.layers, this.add(s);
		let c = new ia(oa, sa, e, t);
...
}, ua = "\\[\\]\\.:\\/", da = /* @__PURE__ */ RegExp("[\\[\\]\\.:\\/]", "g"), fa = "[^\\[\\]\\.:\\/]", pa = "[^" + ua.replace("\\.", "") + "]", ma = /*@__PURE__*/ "((?:WC+[\\/:])*)".replace("WC", fa), ha = /*@__PURE__*/ "(WCOD+)?".replace("WCOD", pa), ga = /*@__PURE__*/ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", fa), _a = /*@__PURE__*/ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", fa), va = RegExp("^" + ma + ha + ga + _a + "$"), ya = [
	"material",
	"materials",
	"bones",
	"map"
...
xa.Composite = ba, xa.prototype.BindingType = {
	Direct: 0,
	EntireArray: 1,
	ArrayElement: 2,
	HasFromToArray: 3
...
}, xa.prototype.GetterByBindingType = [
	xa.prototype._getValue_direct,
	xa.prototype._getValue_array,
	xa.prototype._getValue_arrayElement,
	xa.prototype._getValue_toArray
], xa.prototype.SetterByBindingTypeAndVersioning = [
	[
		xa.prototype._setValue_direct,
		xa.prototype._setValue_direct_setNeedsUpdate,
		xa.prototype._setValue_direct_setMatrixWorldNeedsUpdate
	],
	[
		xa.prototype._setValue_array,
		xa.prototype._setValue_array_setNeedsUpdate,
		xa.prototype._setValue_array_setMatrixWorldNeedsUpdate
	],
	[
		xa.prototype._setValue_arrayElement,
		xa.prototype._setValue_arrayElement_setNeedsUpdate,
		xa.prototype._setValue_arrayElement_setMatrixWorldNeedsUpdate
	],
	[
		xa.prototype._setValue_fromArray,
		xa.prototype._setValue_fromArray_setNeedsUpdate,
		xa.prototype._setValue_fromArray_setMatrixWorldNeedsUpdate
	]
];
var Sa = /*@__PURE__*/ new Jt(), Ca = class {
	constructor(e, t, n = 0, r = Infinity) {
		this.ray = new Fr(e, t), this.near = n, this.far = r, this.camera = null, this.layers = new on(), this.params = {
			Mesh: {},
			Line: { threshold: 1 },
			LOD: {},
			Points: { threshold: 1 },
	...
	setFromCamera(e, t) {
		t.isPerspectiveCamera ? (this.ray.origin.setFromMatrixPosition(t.matrixWorld), this.ray.direction.set(e.x, e.y, .5).unproject(t).sub(this.ray.origin).normalize(), this.camera = t) : t.isOrthographicCamera ? (this.ray.origin.set(e.x, e.y, t.projectionMatrix.elements[14]).unproject(t), this.ray.direction.set(0, 0, -1).transformDirection(t.matrixWorld), this.camera = t) : H("Raycaster: Unsupported camera type: " + t.type);
	}
	...
	intersectObject(e, t = !0, n = []) {
		return Ta(e, this, n, t), n.sort(wa), n;
	}
	intersectObjects(e, t = !0, n = []) {
		for (let r = 0, i = e.length; r < i; r++) Ta(e[r], this, n, t);
		return n.sort(wa), n;
	}
};
function wa(e, t) {
...
function Ta(e, t, n, r) {
	...
	if (e.layers.test(t.layers) && e.raycast(t, n) === !1 && (i = !1), i === !0 && r === !0) {
		let r = e.children;
		for (let e = 0, i = r.length; e < i; e++) Ta(r[e], t, n, !0);
	}
}
var Ea = class {
...
Ma.physical = {
	uniforms: /*@__PURE__*/ Ei([Ma.standard.uniforms, {
		clearcoat: { value: 0 },
...
var Na = {
	...
	b: 0,
	g: 0
}, Pa = /*@__PURE__*/ new Jt(), Fa = /*@__PURE__*/ new q();
...
function Ia(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Jr(new Ci(1, 1, 1), new Ni({
			name: "BackgroundCubeMaterial",
			uniforms: Ti(Ma.backgroundCube.uniforms),
		...
		} }), r.update(l)), l.material.uniforms.envMap.value = i, l.material.uniforms.backgroundBlurriness.value = n.backgroundBlurriness, l.material.uniforms.backgroundIntensity.value = n.backgroundIntensity, l.material.uniforms.backgroundRotation.value.setFromMatrix4(Pa.makeRotationFromEuler(n.backgroundRotation)).transpose(), i.isCubeTexture && i.isRenderTargetTexture === !1 && l.material.uniforms.backgroundRotation.value.premultiply(Fa), l.material.toneMapped = J.getTransfer(i.colorSpace) !== Be, (u !== i || d !== i.version || f !== e.toneMapping) && (l.material.needsUpdate = !0, u = i, d = i.version, f = e.toneMapping), l.layers.enableAll(), t.unshift(l, l.geometry, l.material, 0, 0, null)) : i && i.isTexture && (c === void 0 && (c = new Jr(new wi(2, 2), new Ni({
			name: "BackgroundMaterial",
			uniforms: Ti(Ma.background.uniforms),
	...
	function g(t, r) {
		t.getRGB(Na, ki(e)), n.buffers.color.setClear(Na.r, Na.g, Na.b, r, a);
	}
	function _() {
...
var Va = 4, Ha = [
	...
	.526,
	.582
], Ua = 20, Wa = 256, Ga = /*@__PURE__*/ new aa(), Ka = /*@__PURE__*/ new Y(), qa = null, Ja = 0, Ya = 0, Xa = !1, Za = /*@__PURE__*/ new K(), Qa = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = Za } = i;
		qa = this._renderer.getRenderTarget(), Ja = this._renderer.getActiveCubeFace(), Ya = this._renderer.getActiveMipmapLevel(), Xa = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(qa, Ja, Ya), this._renderer.xr.enabled = Xa, e.scissorTest = !1, to(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), qa = this._renderer.getRenderTarget(), Ja = this._renderer.getActiveCubeFace(), Ya = this._renderer.getActiveMipmapLevel(), Xa = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = $a(r)), this._blurMaterial = ro(r, e, t), this._ggxMaterial = no(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
	...
	_sceneToCubeUV(e, t, n, r, i) {
		...
		c.getClearColor(Ka), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Jr(new Ci(), new Ir({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(Ka), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			to(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = ao()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = io());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		to(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, Ga);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - Va ? n - d + Va : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, to(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, Ga), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, to(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, Ga);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / 39, p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : Ua;
		m > Ua && V(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${Ua}`);
		let h = [], g = 0;
		for (let e = 0; e < Ua; ++e) {
		...
		to(t, 3 * v * (r > _ - Va ? r - _ + Va : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, Ga);
	}
};
function $a(e) {
	let t = [], n = [], r = [], i = e, a = e - Va + 1 + Ha.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - Va ? s = Ha[o - e + Va - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new Tr();
		h.setAttribute("position", new ur(f, 3)), h.setAttribute("uv", new ur(p, 2)), h.setAttribute("faceIndex", new ur(m, 1)), r.push(new Jr(h, null)), i > Va && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function ro(e, t, n) {
	let r = new Float32Array(Ua), i = new K(0, 1, 0);
	return new Ni({
...
var so = class extends Gt {
	constructor(e = 1, t = {}) {
		...
		this.texture = new yi(r), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
	}
	fromEquirectangularTexture(e, t) {
		...
		return t.minFilter === 1008 && (t.minFilter = c), new ca(1, 10, this).update(e, a), t.minFilter = o, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new Qa(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new Qa(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function _o(e, t, n, r, i, a) {
	let o = new Gt(t, n, {
		...
		stencilBuffer: a,
		samples: r ? 4 : 0,
		depthTexture: i ? new bi(t, n) : void 0
	}), s = new Gt(t, n, {
		type: v,
		depthBuffer: !1,
		stencilBuffer: !1
	...
	let l = new Pi({
		...
		depthTest: !1,
		depthWrite: !1
	}), u = new Jr(c, l), d = new aa(-1, 1, 1, -1, 0, 1), f = null, p = null, m = !1, h, g = null, _ = [], y = !1;
...
var vo = /*@__PURE__*/ new Ht(), yo = /*@__PURE__*/ new bi(1, 1), bo = /*@__PURE__*/ new Kt(), xo = /*@__PURE__*/ new qt(), So = /*@__PURE__*/ new yi(), Co = [], wo = [], To = /* @__PURE__ */ new Float32Array(16), Eo = /* @__PURE__ */ new Float32Array(9), Do = /* @__PURE__ */ new Float32Array(4);
function Oo(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Co[i];
	if (a === void 0 && (a = new Float32Array(i), Co[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function jo(e, t) {
	let n = wo[t];
	n === void 0 && (n = new Int32Array(t), wo[t] = n);
...
function Fo(e, t) {
	...
	if (t.x !== void 0) (n[0] !== t.x || n[1] !== t.y || n[2] !== t.z || n[3] !== t.w) && (e.uniform4f(this.addr, t.x, t.y, t.z, t.w), n[0] = t.x, n[1] = t.y, n[2] = t.z, n[3] = t.w);
		...
		if (ko(n, t)) return;
		e.uniform4fv(this.addr, t), Ao(n, t);
	}
}
function Io(e, t) {
	...
	if (r === void 0) {
		...
		if (ko(n, r)) return;
		Do.set(r), e.uniformMatrix2fv(this.addr, !1, Do), Ao(n, r);
	}
}
function Lo(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (ko(n, r)) return;
		Eo.set(r), e.uniformMatrix3fv(this.addr, !1, Eo), Ao(n, r);
	}
}
function Ro(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (ko(n, r)) return;
		To.set(r), e.uniformMatrix4fv(this.addr, !1, To), Ao(n, r);
	}
}
function zo(e, t) {
	let n = this.cache;
...
function qo(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (yo.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = yo) : a = vo, n.setTexture2D(t || a, i);
}
function Jo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || xo, i);
}
function Yo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || So, i);
}
function Xo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || bo, i);
}
function Zo(e) {
	switch (e) {
		case 5126: return Mo;
...
function $o(e, t) {
	let n = Oo(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function es(e, t) {
	let n = Oo(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function ts(e, t) {
	let n = Oo(t, this.size, 4);
...
function rs(e, t) {
	let n = Oo(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function is(e, t) {
	let n = Oo(t, this.size, 16);
...
function ps(e, t, n) {
	let r = this.cache, i = t.length, a = jo(n, i);
	ko(r, a) || (e.uniform1iv(this.addr, a), Ao(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? yo : vo;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function ms(e, t, n) {
	let r = this.cache, i = t.length, a = jo(n, i);
	ko(r, a) || (e.uniform1iv(this.addr, a), Ao(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || xo, a[e]);
}
function hs(e, t, n) {
	let r = this.cache, i = t.length, a = jo(n, i);
	ko(r, a) || (e.uniform1iv(this.addr, a), Ao(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || So, a[e]);
}
function gs(e, t, n) {
	let r = this.cache, i = t.length, a = jo(n, i);
	ko(r, a) || (e.uniform1iv(this.addr, a), Ao(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || bo, a[e]);
}
function _s(e) {
	switch (e) {
		case 5126: return Qo;
		case 35664: return $o;
		case 35665: return es;
		case 35666: return ts;
		case 35674: return ns;
		case 35675: return rs;
		case 35676: return is;
		case 5124:
		case 35670: return as;
		case 35667:
		case 35671: return os;
		case 35668:
		case 35672: return ss;
		case 35669:
		case 35673: return cs;
		case 5125: return ls;
		case 36294: return us;
		case 36295: return ds;
		case 36296: return fs;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		case 35682: return ps;
		case 35679:
		case 36299:
		case 36307: return ms;
		case 35680:
		case 36300:
		case 36308:
		case 36293: return hs;
		case 36289:
		case 36303:
		case 36311:
		case 36292: return gs;
	}
}
var vs = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.setValue = Zo(t.type);
	}
}, ys = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = _s(t.type);
	}
}, bs = class {
	constructor(e) {
...
function Cs(e, t, n) {
	...
	for (xs.lastIndex = 0;;) {
		let a = xs.exec(r), o = xs.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			Ss(n, l === void 0 ? new vs(s, e, t) : new ys(s, e, t));
			break;
		}
		{
			let e = n.map[s];
			e === void 0 && (e = new bs(s), Ss(n, e)), n = e;
		}
	}
}
var ws = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			Cs(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var ks = /*@__PURE__*/ new q();
function As(e) {
	J._getMatrix(ks, J.workingColorSpace, e);
	let t = `mat3( ${ks.elements.map((e) => e.toFixed(4))} )`;
...
var Fs = /*@__PURE__*/ new K();
function Is() {
	return J.getLuminanceCoefficients(Fs), [
...
var qs = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function Js(e) {
	return e.replace(qs, Ys);
}
function Ys(e, t, n, r) {
	let i = "";
...
function Qs(e) {
	return Zs[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var $s = {
...
function ec(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : $s[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var tc = { 302: "ENVMAP_MODE_REFRACTION" };
function nc(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : tc[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var rc = {
...
function oc(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = Qs(n), l = ec(n), u = nc(n), d = ic(n), f = ac(n), p = Ls(n), m = Rs(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		n.toneMapping === 0 ? "" : Ps("toneMapping", n.toneMapping),
	...
	let y = v + g + o, b = v + _ + s, x = Ts(i, i.VERTEX_SHADER, y), S = Ts(i, i.FRAGMENT_SHADER, b);
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) {
				if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
					...
					let e = js(i, x, "vertex"), n = js(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new ws(i, h), T = zs(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, Es)), E;
	}, this.destroy = function() {
		r.releaseStatesOfProgram(this), i.deleteProgram(h), this.program = void 0;
	}, this.type = n.shaderType, this.name = n.shaderName, this.id = Ds++, this.cacheKey = t, this.usedTimes = 1, this.program = h, this.vertexShader = x, this.fragmentShader = S, this;
}
var sc = 0, cc = class {
	constructor() {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new lc(e), t.set(e, n)), n;
	}
}, lc = class {
	constructor(e) {
...
function dc(e, t, n, r, i, a) {
	let o = new on(), s = new cc(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let L = {
			...
			packedNormalMap: oe && i.normalMapType === 0 && uc(i.normalMap.format),
			metalnessMap: F,
			roughnessMap: le,
			anisotropy: ue,
			anisotropyMap: ge,
	...
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new oc(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function hc() {
	...
	function u(e, t, a) {
		n.length > 1 && n.sort(e || pc), r.length > 1 && r.sort(t || mc), i.length > 1 && i.sort(t || mc), a && (n.reverse(), r.reverse(), i.reverse());
	}
	function d() {
...
function gc() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new hc(), e.set(t, [i])) : n >= r.length ? (i = new hc(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function Cc(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new Sc(e), t.set(n, [a])) : r >= i.length ? (a = new Sc(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var wc = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", Tc = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", Ec = [
	...
	/*@__PURE__*/ new K(0, -1, 0),
	/*@__PURE__*/ new K(0, -1, 0)
], Oc = /*@__PURE__*/ new Jt(), kc = /*@__PURE__*/ new K(), Ac = /*@__PURE__*/ new K();
function jc(e, t, n) {
	let r = new ai(), i = new G(), o = new G(), s = new Ut(), l = new Fi(), u = new Ii(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, m = new Ni({
			...
			if (p.camera._reversedDepth = b, p.map === null || h === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new Gt(i.x, i.y, {
						...
						magFilter: c,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new bi(i.x, i.y, _), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = D, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a;
				} else d.isPointLight ? (p.map = new so(i.x), p.map.depthTexture = new xi(i.x, g)) : (p.map = new Gt(i.x, i.y), p.map.depthTexture = new bi(i.x, i.y, g)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = D, this.type === 1 ? (p.map.depthTexture.compareFunction = b ? 518 : 515, p.map.depthTexture.minFilter = c, p.map.depthTexture.magFilter = c) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = a, p.map.depthTexture.magFilter = a);
...
function Nc(e, t, d, f, p, m, h) {
	...
	function T(e, t, n) {
		...
		if ((i.width > n || i.height > n) && (r = n / Math.max(i.width, i.height)), r < 1) {
			...
			return "data" in e && V("WebGLRenderer: Image in DataTexture is too big (" + i.width + "x" + i.height + ")."), e;
		}
		return e;
	}
	function E(e) {
			...
			if (n.isDepthTexture) u = j(n.format === O, n.type), _ && (g ? d.texStorage2D(e.TEXTURE_2D, 1, u, t.width, t.height) : d.texImage2D(e.TEXTURE_2D, 0, u, t.width, t.height, 0, c, l, null));
							...
							if (g) {
								if (v) {
									if (n.layerUpdates.size > 0) {
										let t = Oa(f.width, f.height, n.format, n.type);
				...
				if (g) {
					if (_ && d.texStorage3D(e.TEXTURE_2D_ARRAY, y, u, t.width, t.height, t.depth), v) {
						if (n.layerUpdates.size > 0) {
							let r = Oa(t.width, t.height, n.format, n.type);
							for (let i of n.layerUpdates) {
	...
	function we(t) {
		...
		if (t.depthTexture && !n.__autoAllocateDepthBuffer) {
			if (r) for (let e = 0; e < 6; e++) Ce(n.__webglFramebuffer[e], t, e);
			else {
...
var Fc = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", Ic = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", Lc = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			...
			this.mesh = new Jr(new wi(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, l = null, u = null, f = null, p = null, m = null, h = typeof XRWebGLBinding < "u", _ = new Lc(), v = {}, y = t.getContextAttributes(), b = null, S = null, C = [], w = [], T = new G(), k = null, A = new ia();
		A.viewport = new Ut();
		let j = new ia();
		j.viewport = new Ut();
		let ee = [A, j], M = new la(), te = null, N = null;
			...
			if (r = l, r !== null) {
				if (b = e.getRenderTarget(), r.addEventListener("select", P), r.addEventListener("selectstart", P), r.addEventListener("selectend", P), r.addEventListener("squeeze", P), r.addEventListener("squeezestart", P), r.addEventListener("squeezeend", P), r.addEventListener("end", ne), r.addEventListener("inputsourceschange", re), y.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(T), h && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					u = this.getBinding(), f = u.createProjectionLayer(s), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), S = new Gt(f.textureWidth, f.textureHeight, {
						format: E,
						type: d,
						depthTexture: new bi(f.textureWidth, f.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
...
}, zc = /*@__PURE__*/ new Jt(), Bc = /*@__PURE__*/ new q();
...
function Gc() {
	return Wc === null && (Wc = new Zr(Uc, 16, 16, j, v), Wc.name = "DFG_LUT", Wc.minFilter = c, Wc.magFilter = c, Wc.wrapS = r, Wc.wrapT = r, Wc.generateMipmaps = !1, Wc.needsUpdate = !0), Wc;
}
var Kc = class {
	constructor(e = {}) {
		...
		function it() {
			L = new lo(I), L.init(), tt = new Pc(I, L), Pe = new za(I, L, e, tt), R = new Mc(I, L), Pe.reversedDepthBuffer && p && R.buffers.depth.setReversed(!0), ie = I.createFramebuffer(), ae = I.createFramebuffer(), oe = I.createFramebuffer(), Fe = new po(I), z = new fc(), B = new Nc(I, L, R, z, Pe, tt, Fe), Ie = new co(P), Re = new ja(I), nt = new La(I, Re), ze = new uo(I, Re, Fe, nt), Be = new ho(I, ze, Re, nt, Fe), Ze = new mo(I, Pe, B), Ke = new Ba(z), Ve = new dc(P, Ie, L, Pe, nt, Ke), He = new Vc(P, z), We = new gc(), Ge = new Cc(L), Xe = new Ia(P, Ie, R, Be, _, s), Je = new jc(P, Be, Pe), rt = new Hc(I, Fe, Pe, R), $e = new Ra(I, L, Fe), et = new fo(I, L, Fe), Fe.programs = Ve.programs, P.capabilities = Pe, P.extensions = L, P.properties = z, P.renderLists = We, P.shadowMap = Je, P.state = R, P.info = Fe;
		}
		it(), S !== 1009 && (N = new _o(S, t.width, t.height, o, r, i));
		let U = new Rc(P, I);
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			...
			if (i.isBatchedMesh) {
				if (L.get("WEBGL_multi_draw")) g.renderMultiDraw(i._multiDrawStarts, i._multiDrawCounts, i._multiDrawCount);
				else {
		...
		function St(e) {
			if (e.uniformsList === null) {
				...
				e.uniformsList = ws.seqWithValue(t.seq, e.uniforms);
			}
		...
		function Tt(e, t, n, r, i) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && Ze.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(I, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = Gc()), C) {
				...
				ws.upload(I, St(v), E, B);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (ws.upload(I, St(v), E, B), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(I, "center", i.center), T.setValue(I, "modelViewMatrix", i.modelViewMatrix), T.setValue(I, "normalMatrix", i.normalMatrix), T.setValue(I, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
...
}, qc = { type: "change" }, Jc = { type: "start" }, Yc = { type: "end" }, Xc = new Fr(), Zc = new ti(), Qc = Math.cos(70 * Tt.DEG2RAD), $c = new K(), el = 2 * Math.PI, Q = {
	NONE: -1,
	ROTATE: 0,
	DOLLY: 1,
	PAN: 2,
	...
	constructor(n, r = null) {
		super(n, r), this.state = Q.NONE, this.target = new K(), this.cursor = new K(), this.minDistance = 0, this.maxDistance = Infinity, this.minZoom = 0, this.maxZoom = Infinity, this.minTargetRadius = 0, this.maxTargetRadius = Infinity, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -Infinity, this.maxAzimuthAngle = Infinity, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.keyRotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !0, this.keyPanSpeed = 7, this.zoomToCursor = !1, this.autoRotate = !1, this.autoRotateSpeed = 2, this.keys = {
			...
			ONE: t.ROTATE,
			TWO: t.DOLLY_PAN
		}, this.target0 = this.target.clone(), this.position0 = this.object.position.clone(), this.zoom0 = this.object.zoom, this._cursorStyle = "auto", this._domElementKeyEvents = null, this._lastPosition = new K(), this._lastQuaternion = new Et(), this._lastTargetPosition = new K(), this._quat = new Et().setFromUnitVectors(n.up, new K(0, 1, 0)), this._quatInverse = this._quat.clone().invert(), this._spherical = new Ea(), this._sphericalDelta = new Ea(), this._scale = 1, this._panOffset = new K(), this._rotateStart = new G(), this._rotateEnd = new G(), this._rotateDelta = new G(), this._panStart = new G(), this._panEnd = new G(), this._panDelta = new G(), this._dollyStart = new G(), this._dollyEnd = new G(), this._dollyDelta = new G(), this._dollyDirection = new K(), this._mouse = new G(), this._performCursorZoom = !1, this._pointers = [], this._pointerPositions = {}, this._controlActive = !1, this._onPointerMove = il.bind(this), this._onPointerDown = rl.bind(this), this._onPointerUp = al.bind(this), this._onContextMenu = fl.bind(this), this._onMouseWheel = cl.bind(this), this._onKeyDown = ll.bind(this), this._onTouchStart = ul.bind(this), this._onTouchMove = dl.bind(this), this._onMouseDown = ol.bind(this), this._onMouseMove = sl.bind(this), this._interceptControlDown = pl.bind(this), this._interceptControlUp = ml.bind(this), this.domElement !== null && this.connect(this.domElement), this.update();
	}
	set cursorStyle(e) {
	...
	reset() {
		this.target.copy(this.target0), this.object.position.copy(this.position0), this.object.zoom = this.zoom0, this.object.updateProjectionMatrix(), this.dispatchEvent(qc), this.update(), this.state = Q.NONE;
	}
	pan(e, t) {
	...
	update(e = null) {
		...
		$c.copy(t).sub(this.target), $c.applyQuaternion(this._quat), this._spherical.setFromVector3($c), this.autoRotate && this.state === Q.NONE && this._rotateLeft(this._getAutoRotationAngle(e)), this.enableDamping ? (this._spherical.theta += this._sphericalDelta.theta * this.dampingFactor, this._spherical.phi += this._sphericalDelta.phi * this.dampingFactor) : (this._spherical.theta += this._sphericalDelta.theta, this._spherical.phi += this._sphericalDelta.phi);
		...
		if ($c.setFromSpherical(this._spherical), $c.applyQuaternion(this._quatInverse), t.copy(this.target).add($c), this.object.lookAt(this.target), this.enableDamping === !0 ? (this._sphericalDelta.theta *= 1 - this.dampingFactor, this._sphericalDelta.phi *= 1 - this.dampingFactor, this._panOffset.multiplyScalar(1 - this.dampingFactor)) : (this._sphericalDelta.set(0, 0, 0), this._panOffset.set(0, 0, 0)), this.zoomToCursor && this._performCursorZoom) {
			...
			if (this.object.isPerspectiveCamera) {
				...
				r.unproject(this.object), this.object.position.sub(r).add(t), this.object.updateMatrixWorld(), e = $c.length();
			...
			e !== null && (this.screenSpacePanning ? this.target.set(0, 0, -1).transformDirection(this.object.matrix).multiplyScalar(e).add(this.object.position) : (Xc.origin.copy(this.object.position), Xc.direction.set(0, 0, -1).transformDirection(this.object.matrix), Math.abs(this.object.up.dot(Xc.direction)) < Qc ? this.object.lookAt(this.target) : (Zc.setFromNormalAndCoplanarPoint(this.object.up, this.target), Xc.intersectPlane(Zc, this.target))));
		} else if (this.object.isOrthographicCamera) {
		...
		return this._scale = 1, this._performCursorZoom = !1, i || this._lastPosition.distanceToSquared(this.object.position) > tl || 8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > tl || this._lastTargetPosition.distanceToSquared(this.target) > tl ? (this.dispatchEvent(qc), this._lastPosition.copy(this.object.position), this._lastQuaternion.copy(this.object.quaternion), this._lastTargetPosition.copy(this.target), !0) : !1;
	}
	_getAutoRotationAngle(e) {
		return e === null ? el / 60 / 60 * this.autoRotateSpeed : el / 60 * this.autoRotateSpeed * e;
	}
	_getZoomScale(e) {
		let t = Math.abs(e * .01);
	...
	_handleMouseMoveRotate(e) {
		...
		this._rotateLeft(el * this._rotateDelta.x / t.clientHeight), this._rotateUp(el * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd), this.update();
	}
	...
	_handleKeyDown(e) {
		...
		switch (e.code) {
			case this.keys.UP:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(el * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, this.keyPanSpeed), t = !0;
				break;
			case this.keys.BOTTOM:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateUp(-el * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(0, -this.keyPanSpeed), t = !0;
				break;
			case this.keys.LEFT:
				e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(el * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(this.keyPanSpeed, 0), t = !0;
				break;
			case this.keys.RIGHT: e.ctrlKey || e.metaKey || e.shiftKey ? this.enableRotate && this._rotateLeft(-el * this.keyRotateSpeed / this.domElement.clientHeight) : this.enablePan && this._pan(-this.keyPanSpeed, 0), t = !0;
		}
	...
	_handleTouchMoveRotate(e) {
		...
		let t = this.domElement;
		this._rotateLeft(el * this._rotateDelta.x / t.clientHeight), this._rotateUp(el * this._rotateDelta.y / t.clientHeight), this._rotateStart.copy(this._rotateEnd);
	}
...
function al(e) {
	switch (this._removePointer(e), this._pointers.length) {
		case 0:
			this.domElement.releasePointerCapture(e.pointerId), this.domElement.ownerDocument.removeEventListener("pointermove", this._onPointerMove), this.domElement.ownerDocument.removeEventListener("pointerup", this._onPointerUp), this.dispatchEvent(Yc), this.state = Q.NONE, this._cursorStyle === "grab" && (this.domElement.style.cursor = "grab");
			break;
		case 1:
...
function ol(t) {
	...
	this.state !== Q.NONE && this.dispatchEvent(Jc);
}
function sl(e) {
	switch (this.state) {
		case Q.ROTATE:
...
function cl(e) {
	this.enabled !== !1 && this.enableZoom !== !1 && this.state === Q.NONE && (e.preventDefault(), this.dispatchEvent(Jc), this._handleMouseWheel(this._customWheelEvent(e)), this.dispatchEvent(Yc));
}
function ll(e) {
...
function vl(e) {
	return e instanceof ArrayBuffer ? new Uint8Array(e.slice(0)) : new Uint8Array(e.buffer.slice(e.byteOffset, e.byteOffset + e.byteLength));
}
function yl(e, t) {
	let n = vl(t);
	if (n.byteLength !== e.byte_length) throw Error(`buffer ${e.index} byte length differs from metadata`);
	let r = e.scalar_type === "float64-le" ? 8 : 4;
	if (e.shape.reduce((e, t) => e * t, 1) * r !== n.byteLength) throw Error(`buffer ${e.index} shape differs from byte length`);
	let i = new DataView(n.buffer, n.byteOffset, n.byteLength);
	if (e.scalar_type === "float64-le") {
		let t = new Float64Array(n.byteLength / 8);
		for (let n = 0; n < t.length; n += 1) if (t[n] = i.getFloat64(n * 8, !0), !Number.isFinite(t[n])) throw Error(`buffer ${e.index} contains a non-finite float`);
		return t;
	}
	let a = new Uint32Array(n.byteLength / 4);
	for (let e = 0; e < a.length; e += 1) a[e] = i.getUint32(e * 4, !0);
	return a;
}
function bl(e, t) {
	let n = e.buffers[t.buffer];
	if (n === void 0 || n.index !== t.buffer) throw Error(`layer references absent buffer ${t.buffer}`);
	return n.shape;
}
function xl(e, t, n, r) {
	let i = bl(e, t);
	if (i.length !== n.length || i.some((e, t) => e !== n[t])) throw Error(`${r} has shape [${i.join(",")}], expected [${n.join(",")}]`);
}
function Sl(e) {
	let t = hl(JSON.parse(e), "scene metadata");
	if (t.schema !== "eqiora.viewer.scene/v0-private" || !Array.isArray(t.layers) || !Array.isArray(t.buffers)) throw Error("unsupported private Eqiora viewer scene");
	let n = t.buffers.map((e, t) => {
		let n = hl(e, `buffers[${t}]`), r = n.scalar_type;
		if (r !== "float64-le" && r !== "uint32-le") throw Error(`buffers[${t}] has unsupported scalar type`);
		if (!Array.isArray(n.shape) || n.shape.length === 0) throw Error(`buffers[${t}] has invalid shape`);
		let i = n.shape.map((e, n) => {
			let r = _l(e, `buffers[${t}].shape[${n}]`);
			if (r === 0) throw Error(`buffers[${t}] has an empty axis`);
			return r;
		}), a = gl(n.sha256, `buffers[${t}].sha256`);
		if (!/^[0-9a-f]{64}$/.test(a)) throw Error(`buffers[${t}] has invalid sha256`);
		return {
			index: _l(n.index, `buffers[${t}].index`),
			role: gl(n.role, `buffers[${t}].role`),
			scalar_type: r,
			shape: i,
			byte_length: _l(n.byte_length, `buffers[${t}].byte_length`),
			sha256: a
		};
	});
	if (n.some((e, t) => e.index !== t)) throw Error("scene buffer indices are not canonical");
	return {
		...t,
		buffers: n
	};
...
function Cl(e) {
	let { metadata: t, buffers: n } = e, r = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Set();
	for (let e of t.layers) {
		let a = hl(e, "layer");
		if (!gl(a.id, "layer.id") || i.has(a.id)) throw Error("scene repeats a layer id");
		if (i.add(a.id), a.kind === "geometry") {
			if (a.dimension !== 2) throw Error("v0 GeometryLayer must be two-dimensional");
			xl(t, a.positions, [bl(t, a.positions)[0], 2], "Geometry positions");
			let e = bl(t, a.segments)[0];
			xl(t, a.segments, [e, 2], "Geometry segments"), xl(t, a.source_entities, [e], "Geometry source entities");
			let i = n[a.positions.buffer], o = n[a.segments.buffer], s = n[a.source_entities.buffer];
			if (!(i instanceof Float64Array) || !(o instanceof Uint32Array) || !(s instanceof Uint32Array)) throw Error("Geometry buffer types disagree");
			let c = i.length / 2;
			if (o.some((e) => e >= c)) throw Error("Geometry segment is out of range");
			r.set(a.id, a);
		} else if (a.kind === "mesh") {
			let e = a.cell_kind === "triangle" ? 3 : a.cell_kind === "quadrilateral" ? 4 : 0;
			if (a.dimension !== 2 || e === 0) throw Error("v0 MeshLayer has unsupported topology");
			xl(t, a.coordinates, [a.vertex_count, 2], "Mesh coordinates"), xl(t, a.connectivity, [a.cell_count, e], "Mesh connectivity");
			let i = n[a.connectivity.buffer];
			if (!(n[a.coordinates.buffer] instanceof Float64Array) || !(i instanceof Uint32Array)) throw Error("Mesh buffer types disagree");
			if (i.some((e) => e >= a.vertex_count)) throw Error("Mesh connectivity is out of range");
			r.set(a.id, a);
		} else if (a.kind !== "selection" && a.kind !== "scalar-field") throw Error(`private v0 scene has unsupported layer kind ${String(a.kind)}`);
	}
	for (let e of t.layers) if (e.kind === "selection") {
		let i = r.get(e.target_layer);
		if (i === void 0 || i.owner_digest !== e.owner_digest) throw Error("SelectionLayer has a foreign owner");
		if (i.kind === "mesh" && i.correspondence_digest !== e.correspondence_digest) throw Error("SelectionLayer has a foreign correspondence");
		if (e.available) {
			if (e.unavailable_reason !== null) throw Error("available SelectionLayer has an unavailable reason");
			if (e.entity_indices === null) throw Error("available SelectionLayer omits membership");
			let r = n[e.entity_indices.buffer];
			if (!(r instanceof Uint32Array)) throw Error("Selection membership is not uint32");
			let a = bl(t, e.entity_indices);
			if (a.length !== 1) throw Error("Selection membership is not one-dimensional");
			let o = a[0];
			if (i.kind === "geometry") {
				if (e.dimension !== 1) throw Error("Geometry selection has unsupported dimension");
				if (e.connectivity !== null) throw Error("Geometry selection fabricates connectivity");
				let n = bl(t, i.segments)[0];
				if (r.some((e) => e >= n)) throw Error("Geometry selection primitive is out of range");
			} else {
				if (e.dimension !== 1 && e.dimension !== 2) throw Error("Mesh selection has unsupported dimension");
				if (e.connectivity === null) throw Error("Mesh selection omits exact connectivity");
				let r = n[e.connectivity.buffer], a = e.dimension === 1 ? 2 : i.cell_kind === "triangle" ? 3 : 4;
				if (xl(t, e.connectivity, [o, a], "Mesh selection connectivity"), !(r instanceof Uint32Array) || r.some((e) => e >= i.vertex_count)) throw Error("Mesh selection connectivity is invalid");
			}
		} else if (e.unavailable_reason === null || e.entity_indices !== null || e.connectivity !== null) throw Error("unavailable SelectionLayer is not explicit");
	} else if (e.kind === "scalar-field") {
		let i = r.get(e.target_layer);
		if (i?.kind !== "mesh" || i.owner_digest !== e.mesh_digest) throw Error("ScalarFieldLayer has a foreign Mesh owner");
		if (e.component_shape.length !== 0 || e.unit !== "coherent-si" || e.frame !== "scalar") throw Error("v0 ScalarFieldLayer is not scalar");
		let a = e.association === "vertex" ? i.vertex_count : e.association === "cell" ? i.cell_count : 0;
		if (a === 0) throw Error("ScalarFieldLayer has unsupported association");
		if (xl(t, e.values, [a], "Scalar field values"), !(n[e.values.buffer] instanceof Float64Array)) throw Error("Scalar field values are not float64");
	}
}
function wl(e, t) {
	let n = Sl(e);
	if (t.length !== n.buffers.length) throw Error("scene binary buffer count differs from metadata");
	let r = {
		metadata: n,
		buffers: n.buffers.map((e, n) => yl(e, t[n]))
	};
	return Cl(r), r;
}
//#endregion
...
function $(e, t, n) {
	...
	return r.className = t, n.append(r), r;
}
function Tl(e, t, n) {
	let r = $("button", "eqiora-viewer__button", t);
	return r.type = "button", r.textContent = e, r.setAttribute("aria-label", e), r.addEventListener("click", n), r;
}
function El(e, t) {
	let n = e.buffers[t.buffer];
	if (!(n instanceof Float64Array)) throw Error("viewer expected float64 buffer");
	return n;
}
function Dl(e, t) {
	let n = e.buffers[t.buffer];
	if (!(n instanceof Uint32Array)) throw Error("viewer expected uint32 buffer");
	return n;
}
function Ol(e) {
	let t = new Float32Array(e.length / 2 * 3);
	for (let n = 0; n < e.length / 2; n += 1) t[n * 3] = e[n * 2], t[n * 3 + 1] = e[n * 2 + 1], t[n * 3 + 2] = 0;
	return t;
}
function kl(e, t) {
	let n = new Float32Array(t.length / 2 * 6);
	for (let r = 0; r < t.length / 2; r += 1) for (let i = 0; i < 2; i += 1) {
		let a = t[r * 2 + i], o = r * 6 + i * 3;
		n[o] = e[a * 3], n[o + 1] = e[a * 3 + 1], n[o + 2] = e[a * 3 + 2];
	}
	return n;
}
function Al(e, t) {
	let n = new Uint32Array(e.length / t * t * 2), r = 0;
	for (let i = 0; i < e.length / t; i += 1) for (let a = 0; a < t; a += 1) n[r++] = e[i * t + a], n[r++] = e[i * t + (a + 1) % t];
	return n;
}
function jl(e, t) {
	if (t === 3) return {
		indices: new Uint32Array(e),
		triangleToCell: Array.from({ length: e.length / 3 }, (e, t) => t)
	};
	let n = e.length / 4, r = new Uint32Array(n * 6), i = [];
	for (let t = 0; t < n; t += 1) {
		let [n, a, o, s] = e.subarray(t * 4, t * 4 + 4);
		r.set([
			n,
			a,
			o,
...
function Ml(e, t, n, r) {
	let i = new Tr();
	i.setAttribute("position", new ur(kl(e, t), 3));
	let a = new oi({ color: n });
	return r.disposables.push(i, a), new vi(i, a);
}
function Nl(e, t, n) {
	let r = El(e, t.positions), i = Dl(e, t.segments), a = Ol(r), o = new Cn(), s = Ml(a, i, 2437962, n);
	o.add(s), n.scene.add(o), n.targets.set(t.id, {
		layer: t,
		group: o,
		coordinates: r,
		connectivity: i,
...
function Pl(e, t, n) {
	let r = El(e, t.coordinates), i = Dl(e, t.connectivity), a = Ol(r), o = t.cell_kind === "triangle" ? 3 : 4, s = jl(i, o), c = new Tr();
	c.setAttribute("position", new ur(a, 3)), c.setIndex(new ur(s.indices, 1));
	let l = new Ir({
		color: 7841240,
		side: 2,
		transparent: !0,
	...
	u.userData.eqioraTarget = t.id;
	let d = Ml(a, Al(i, o), 2307405, n), f = new Cn();
	f.add(u, d), n.disposables.push(c, l), n.scene.add(f), n.targets.set(t.id, {
		layer: t,
		group: f,
		coordinates: r,
		connectivity: i,
		surface: u,
		edges: d,
		triangleToCell: s.triangleToCell
	});
}
function Fl(e, t, n) {
	let r = n === t ? .5 : Math.min(1, Math.max(0, (e - t) / (n - t)));
	return new Y().setHSL(2 / 3 * (1 - r), .78, .52);
}
function Il(e, t, n) {
	if (n.layer.kind !== "mesh") throw Error("field target is not a MeshLayer");
	let r = El(e, t.values), i = n.layer.cell_kind === "triangle" ? 3 : 4, a = jl(n.connectivity, i).indices, o = new Float32Array(a.length * 3), s = new Float32Array(a.length * 3);
	for (let e = 0; e < a.length; e += 1) {
		...
		let c = Math.floor(e / 3), l = n.triangleToCell[c], u = Fl(t.association === "vertex" ? r[i] : r[l], t.scale.minimum, t.scale.maximum);
		s.set(u.toArray(), e * 3);
	}
	let c = new Tr();
	c.setAttribute("position", new ur(o, 3)), c.setAttribute("color", new ur(s, 3));
	let l = new Jr(c, new Ir({
		vertexColors: !0,
		side: 2
	}));
	return l.userData.eqioraTarget = n.layer.id, l.userData.eqioraField = t.id, l;
}
function Ll(e) {
	if (e === null) return;
	e.removeFromParent();
	let t = e;
	t.geometry?.dispose();
	let n = Array.isArray(t.material) ? t.material : t.material === void 0 ? [] : [t.material];
	for (let e of n) e.dispose();
}
function Rl(e, t, n) {
	Ll(t.fieldSurface), t.fieldSurface = null, t.selectedField = n;
	for (let e of t.targets.values()) e.surface !== null && (e.surface.visible = t.surfacesVisible);
	if (n === null) return;
	let r = t.targets.get(n.target_layer);
	if (r === void 0 || r.surface === null) throw Error("field target disappeared");
	r.surface.visible = !1, t.fieldSurface = Il(e, n, r), t.fieldSurface.visible = t.surfacesVisible && !t.selectionIsolated, t.scene.add(t.fieldSurface);
}
function zl(e, t, n, r) {
	let i = t.targets.get(n.target_layer);
	if (i === void 0 || n.entity_indices === null) throw Error("selection target disappeared");
	let a = Ol(i.coordinates), o;
	if (n.connectivity !== null) o = Dl(e, n.connectivity);
	else {
		let t = Dl(e, n.entity_indices);
		o = new Uint32Array(t.length * 2), t.forEach((e, t) => {
			o[t * 2] = i.connectivity[e * 2], o[t * 2 + 1] = i.connectivity[e * 2 + 1];
		});
	}
	if (n.dimension === 1) return Ml(a, o, r, t);
	let s = o.length / Dl(e, n.entity_indices).length, c = jl(o, s).indices, l = new Tr();
	l.setAttribute("position", new ur(a, 3)), l.setIndex(new ur(c, 1));
	let u = new Jr(l, new Ir({
		color: r,
		side: 2,
		transparent: !0,
		opacity: .9,
	...
	return u.renderOrder = 3, u;
}
function Bl(e, t, n, r, i) {
	Ll(t.highlight), t.highlight = null, t.selectedSelection = n, t.selectionIsolated = !!(n?.available && i);
	for (let e of t.targets.values()) e.group.visible = !0;
	if (t.fieldSurface !== null && (t.fieldSurface.visible = t.surfacesVisible && !t.selectionIsolated), !(n === null || !n.available) && (t.highlight = zl(e, t, n, r), t.scene.add(t.highlight), t.selectionIsolated)) for (let e of t.targets.values()) e.group.visible = !1;
}
function Vl(e) {
	let t = new Kn().setFromObject(e.scene);
	if (t.isEmpty()) throw Error("viewer scene has no visible bounds");
	let n = t.getCenter(new K()), r = t.getSize(new K()), i = Math.max(r.x, r.y, r.z, 1e-9), a = n.clone().add(new K(i * 1.35, -i * 1.35, i * 1.75));
	return e.camera.position.copy(a), e.controls.target.copy(n), e.controls.update(), {
		position: a,
		target: n
	};
}
function Hl(e) {
	e.cleaned || e.frame !== 0 || (e.frame = requestAnimationFrame(() => {
		e.frame = 0, e.cleaned || e.renderer.render(e.scene, e.camera);
	}));
}
function Ul(e) {
...
function Wl(e, t, n, r, i) {
	...
	s.setFromCamera(o, n.camera);
	let c = [n.fieldSurface, ...Array.from(n.targets.values(), (e) => e.surface)].filter((e) => e?.visible === !0), l = s.intersectObjects(c, !1)[0];
	if (l === void 0 || l.faceIndex === void 0 || l.faceIndex === null) {
		i.value = "No exact accepted primitive selected";
		return;
	}
	let u = Gl(l.object.userData.eqioraTarget), d = n.targets.get(u);
	if (d?.layer.kind !== "mesh") {
		i.value = "Geometry line picking is unavailable in this projection";
		return;
	}
	let f = l.faceIndex, p = d.triangleToCell[f], m = n.selectedField;
	if (m === null || m.target_layer !== u) {
		i.value = `Accepted Mesh cell ${p}`;
		return;
	}
	let h = El(r, m.values);
	if (m.association === "cell") {
		i.value = `Accepted cell ${p}: ${h[p]} ${Ul(m)}`;
		return;
	}
	let g = d.layer.cell_kind === "triangle" ? 3 : 4, _ = d.connectivity.subarray(p * g, p * g + g), v = _[0], y = Infinity;
	for (let e of _) {
		let t = d.coordinates[e * 2] - l.point.x, n = d.coordinates[e * 2 + 1] - l.point.y, r = t * t + n * n;
		r < y && (y = r, v = e);
	}
	i.value = `Accepted vertex ${v}: ${h[v]} ${Ul(m)}`;
}
function Gl(e) {
	return typeof e == "string" ? e : "";
}
function Kl(e, t) {
	let n = $("section", "eqiora-viewer", e);
	n.setAttribute("aria-label", "Eqiora semantic scene viewer"), n.dataset.sceneSchema = t.metadata.schema;
	let r = $("div", "eqiora-viewer__heading", n), i = $("strong", "eqiora-viewer__title", r);
	i.textContent = "Eqiora Viewer";
	let a = $("span", "eqiora-viewer__summary", r);
	a.textContent = `${t.metadata.layers.length} typed layers · presentation only`;
	let o = $("div", "eqiora-viewer__toolbar", n);
	o.setAttribute("role", "toolbar"), o.setAttribute("aria-label", "Viewer controls");
	let s = $("div", "eqiora-viewer__viewport", n), c = $("aside", "eqiora-viewer__inspector", n);
	return c.setAttribute("aria-label", "Accepted value inspector"), {
		root: n,
		toolbar: o,
		viewport: s,
		inspector: c
...
function ql(e, t, n, r, i) {
	let a = $("div", "eqiora-viewer__control-group", n);
	a.setAttribute("aria-label", "Camera controls");
	let o = (e) => {
		t.camera.position.add(e), t.controls.update(), Hl(t);
	};
	Tl("Orbit", a, () => {
		let e = t.camera.position.clone().sub(t.controls.target);
		o(new K(-e.z - e.x, 0, e.x - e.z));
	}), Tl("Pan", a, () => o(new K(.1, 0, 0))), Tl("Zoom in", a, () => {
		t.camera.position.lerp(t.controls.target, .2), Hl(t);
	}), Tl("Zoom out", a, () => {
		t.camera.position.sub(t.controls.target).multiplyScalar(1.25).add(t.controls.target), Hl(t);
	}), Tl("Reset", a, () => {
		t.camera.position.copy(i.position), t.controls.target.copy(i.target), t.controls.update(), Hl(t);
	});
	let s = $("fieldset", "eqiora-viewer__control-group", n), c = $("legend", "eqiora-viewer__legend", s);
	c.textContent = "Visibility";
	for (let [e, n] of [["Surfaces", "surface"], ["Edges", "edges"]]) {
		let r = $("label", "eqiora-viewer__toggle", s), i = $("input", "", r);
		i.type = "checkbox", i.checked = !0, r.append(e), i.addEventListener("change", () => {
			for (let e of t.targets.values()) n === "surface" && e.surface !== null && (e.surface.visible = i.checked), n === "edges" && (e.edges.visible = i.checked);
			n === "surface" ? (t.surfacesVisible = i.checked, t.fieldSurface !== null && (t.fieldSurface.visible = i.checked && !t.selectionIsolated)) : t.edgesVisible = i.checked, Hl(t);
		});
	}
	let l = e.metadata.layers.filter((e) => e.kind === "selection"), u = $("label", "eqiora-viewer__label", n);
	u.append("Selection");
	let d = $("select", "eqiora-viewer__select", u), f = $("option", "", d);
	f.value = "", f.textContent = "None";
	for (let e of l) {
		let t = $("option", "", d);
		t.value = e.id, t.textContent = `${e.name} · ${e.target_layer.startsWith("mesh:") ? "Mesh" : "Geometry"}`, t.disabled = !e.available, e.available || (t.title = e.unavailable_reason ?? "Unavailable");
	}
	let p = $("label", "eqiora-viewer__label", n);
	p.append("Selection colour");
	let m = $("input", "eqiora-viewer__color", p);
	m.type = "color", m.value = "#f26b38";
	let h = $("label", "eqiora-viewer__toggle", n), g = $("input", "", h);
	g.type = "checkbox", h.append("Isolate exact selection");
	let _ = () => {
		Bl(e, t, l.find((e) => e.id === d.value) ?? null, m.value, g.checked), Hl(t);
	};
	d.addEventListener("change", _), m.addEventListener("input", _), g.addEventListener("change", _);
	let v = e.metadata.layers.filter((e) => e.kind === "scalar-field"), y = $("label", "eqiora-viewer__label", n);
	y.append("Scalar field");
	let b = $("select", "eqiora-viewer__select", y), x = $("option", "", b);
	x.value = "", x.textContent = "None";
	for (let e of v) {
		let t = $("option", "", b);
		t.value = e.id, t.textContent = `${e.field_id} · ${e.association}`;
	}
	let S = $("output", "eqiora-viewer__field-legend", r);
	S.setAttribute("aria-live", "polite"), b.addEventListener("change", () => {
		let n = v.find((e) => e.id === b.value) ?? null;
		Rl(e, t, n), S.value = n === null ? "No scalar field selected" : `${n.field_id}: ${n.scale.minimum} to ${n.scale.maximum} ${Ul(n)}; ${n.scale.provenance}`, Hl(t);
	}), S.value = "No scalar field selected";
}
function Jl(e) {
	let t = new Kc({
		antialias: !0,
	...
	t.setClearColor(16054267, 1), t.setPixelRatio(Math.min(globalThis.devicePixelRatio || 1, 2));
	let n = t.domElement;
	n.className = "eqiora-viewer__canvas", n.tabIndex = 0, n.setAttribute("role", "img"), n.setAttribute("aria-label", "Interactive read-only Eqiora scene. Picking reports only exact accepted entity values."), e.append(n);
	let r = new ia(42, 1, 1e-6, 1e9);
	r.up.set(0, 1, 0);
	let i = new nl(r, n);
	return i.enablePan = !0, i.enableRotate = !0, i.enableZoom = !0, {
		scene: new jn(),
		renderer: t,
		camera: r,
		controls: i,
...
function Yl(e, t, n) {
	let r = wl(t, n);
	e.replaceChildren();
	let i = Kl(e, r), a = Jl(i.viewport);
	for (let e of r.metadata.layers) e.kind === "geometry" && Nl(r, e, a), e.kind === "mesh" && Pl(r, e, a);
	let o = Vl(a);
	ql(r, a, i.toolbar, i.inspector, o);
	let s = $("output", "eqiora-viewer__picked", i.inspector);
	s.setAttribute("aria-live", "polite"), s.value = "Pick a visible primitive to inspect an exact accepted value";
	let c = a.renderer.domElement, l = (e) => {
		Wl(e, c, a, r, s);
	};
	c.addEventListener("pointerdown", l);
	let u = () => Hl(a);
	a.controls.addEventListener("change", u);
	let d = new ResizeObserver(() => {
		let e = i.viewport.getBoundingClientRect(), t = Math.max(1, Math.floor(e.width)), n = Math.max(1, Math.floor(e.height));
		a.renderer.setSize(t, n, !1), a.camera.aspect = t / n, a.camera.updateProjectionMatrix(), Hl(a);
	});
	return d.observe(i.viewport), Hl(a), { cleanup: () => {
		if (!a.cleaned) {
			a.cleaned = !0, d.disconnect(), c.removeEventListener("pointerdown", l), a.controls.removeEventListener("change", u), a.controls.dispose(), a.frame !== 0 && cancelAnimationFrame(a.frame), Ll(a.highlight), Ll(a.fieldSurface);
			for (let e of a.disposables) e.dispose();
			a.scene.clear(), a.renderer.dispose(), a.renderer.forceContextLoss(), i.root.remove();
		}
	} };
}
function Xl(e, t) {
	let n = document.createElement("p");
	n.className = "eqiora-viewer__diagnostic", n.setAttribute("role", "alert"), n.textContent = `Eqiora Viewer unavailable: ${t instanceof Error ? t.message : String(t)}`, e.replaceChildren(n);
}
var Zl = { render: ({ model: e, el: t }) => {
	try {
		let n = e.get("scene_metadata"), r = e.get("buffers");
		if (typeof n != "string" || !Array.isArray(r)) throw Error("Notebook host omitted the private scene metadata or binary buffers");
		let i = Yl(t, n, r), a = () => i.cleanup();
		return e.on("destroy", a), e.on("comm:close", a), () => {
			e.off("destroy", a), e.off("comm:close", a), a();
		};
	} catch (e) {
		return Xl(t, e), () => t.replaceChildren();
	}
} };
//#endregion
export { wl as decodeScene, Zl as default, Yl as mountEqioraViewer };
