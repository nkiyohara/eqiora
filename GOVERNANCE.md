...
- Verification authority remains independently derived from implementation output and scoped to
  the claim it can falsify under [RFC 0089](rfcs/0089-resume-claim-local-evidence-development.md).
