...
export const CURRENT_MODEL_SCHEMA = "eqiora.model-envelope/v18" as const;
export const CURRENT_MODEL_TRANSACTION_SCHEMA = "eqiora.model-transaction-envelope/v18" as const;
