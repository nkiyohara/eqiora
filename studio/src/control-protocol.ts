...
export const CURRENT_MODEL_SCHEMA = "eqiora.model-envelope/v20" as const;
export const CURRENT_MODEL_TRANSACTION_SCHEMA = "eqiora.model-transaction-envelope/v20" as const;
