...
export const CURRENT_MODEL_SCHEMA = "eqiora.model-envelope/v23" as const;
export const CURRENT_MODEL_TRANSACTION_SCHEMA = "eqiora.model-transaction-envelope/v23" as const;
