...
export const CURRENT_MODEL_SCHEMA = "eqiora.model-envelope/v24" as const;
export const CURRENT_MODEL_TRANSACTION_SCHEMA = "eqiora.model-transaction-envelope/v24" as const;
