...
| `exact-cylinder-stokes` | [`python/exact_cylinder_stokes.py`](python/exact_cylinder_stokes.py) | From an installed `eqiora` package, execute the accepted exact-cylinder steady-Stokes composition and inspect its immutable pressure, solver, force, and flux evidence. |
